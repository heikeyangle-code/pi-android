...
| RR F32/P9 (markdown config rebuilt per frame) | **Done in the tree before `ui/render/**` changed hands** | `PiMarkdown.kt` now remembers the five config objects against palette/typography. Reported, not owned, from here on. |
